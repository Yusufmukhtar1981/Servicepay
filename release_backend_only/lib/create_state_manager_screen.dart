...
class CreateStateManagerScreen extends StatefulWidget {
  ...
  @override
  State<CreateStateManagerScreen> createState() =>
      _CreateStateManagerScreenState();
}

class _CreateStateManagerScreenState extends State<CreateStateManagerScreen> {
  ...
  Future<void> createStateManager() async {
    if (isSaving) {
      return;
    }
    ...
    try {
      ...
      final Uri uri = Uri.parse(
        '$baseUrl/management/state-managers',
      );
      ...
      final String message = result['message']?.toString().trim() ??
          'Unable to create State Manager.';
            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'The account will be linked automatically to your zonal account.',
                            style: TextStyle(
              ...
              Container(
                ...
                child: const Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'The State Manager can change the temporary password after signing in.',
                        style: TextStyle(
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  onPressed: isSaving ? null : createStateManager,
                  ...
                  label: Text(
                    isSaving ? 'Creating Account...' : 'Create State Manager',
