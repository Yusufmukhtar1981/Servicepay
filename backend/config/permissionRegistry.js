...
const STAFF_PERMISSION_CATALOG = Object.freeze([
  ...
  permission("HIERARCHY_MANAGE", "hierarchy.manage", "USERS", "Manage hierarchy assignments", "Assign and reassign operational reporting relationships without changing user roles.", "CRITICAL"),
  ...
  permission("ORGANIZATIONS_WITHDRAWALS_VIEW", "organizations.withdrawals.view", "ORGANIZATIONS", "View organization withdrawals", "View organization treasury withdrawals."),
  permission("ORGANIZATIONS_WITHDRAWALS_REVIEW", "organizations.withdrawals.review", "ORGANIZATIONS", "Review organization withdrawals", "Approve or reject organization treasury withdrawals.", "CRITICAL"),
  permission("ORGANIZATIONS_SETTLEMENT_ACCOUNTS_VIEW", "organizations.settlement_accounts.view", "ORGANIZATIONS", "View settlement accounts", "View organization settlement account submissions."),
  permission("ORGANIZATIONS_SETTLEMENT_ACCOUNTS_REVIEW", "organizations.settlement_accounts.review", "ORGANIZATIONS", "Review settlement accounts", "Approve or reject organization settlement accounts.", "CRITICAL"),
  permission("ORGANIZATIONS_TREASURY_MANAGE", "organizations.treasury.manage", "ORGANIZATIONS", "Manage treasury configuration", "Configure organization treasury limits and authorization.", "CRITICAL"),
  permission("ORGANIZATIONS_MEMBERS_VIEW", "organizations.members.view", "ORGANIZATIONS", "View organization members", "View organization members within scope."),
  permission("ORGANIZATIONS_PAYMENTS_VIEW", "organizations.payments.view", "ORGANIZATIONS", "View organization payments", "View organization payments within scope."),
  permission("ORGANIZATIONS_AUDIT_VIEW", "organizations.audit.view", "ORGANIZATIONS", "View organization audit", "View organization audit records."),
  ...
  permission("BUSINESS_PARTNERS_CUSTOMERS_VIEW", "business_partners.customers.view", "BUSINESS_PARTNERS", "View partner customers", "View masked customers belonging to a distributor Business Partner."),
  permission("BUSINESS_PARTNERS_OFFICERS_VIEW", "business_partners.officers.view", "BUSINESS_PARTNERS", "View partner officers", "View officers belonging to a distributor Business Partner."),
  permission("BUSINESS_PARTNERS_TRANSACTIONS_VIEW", "business_partners.transactions.view", "BUSINESS_PARTNERS", "View partner transactions", "View masked transactions belonging to a distributor Business Partner."),
  permission("BUSINESS_PARTNERS_COMMISSIONS_VIEW", "business_partners.commissions.view", "BUSINESS_PARTNERS", "View partner commissions", "View distributor commission ledger and aggregates."),
  permission("BUSINESS_PARTNERS_TARGETS_VIEW", "business_partners.targets.view", "BUSINESS_PARTNERS", "View partner targets", "View distributor target configuration."),
  permission("BUSINESS_PARTNERS_BONUSES_VIEW", "business_partners.bonuses.view", "BUSINESS_PARTNERS", "View partner bonuses", "View recorded distributor bonus history."),
  permission("BUSINESS_PARTNERS_LIABILITIES_VIEW", "business_partners.liabilities.view", "BUSINESS_PARTNERS", "View partner liabilities", "View calculated distributor commission liabilities."),
  permission("BUSINESS_PARTNERS_AUDIT_VIEW", "business_partners.audit.view", "BUSINESS_PARTNERS", "View partner audit", "View distributor-specific audit records."),
  ...
  permission("ANNOUNCEMENTS_PARTICIPANTS_VIEW", "announcements.participants.view", "COMMUNICATIONS", "View campaign participants", "View tracked announcement campaign participants and progress."),
  permission("ANNOUNCEMENTS_PARTICIPANTS_HISTORY_VIEW", "announcements.participants.history_view", "COMMUNICATIONS", "View campaign winner history", "View immutable tracked campaign winner history."),
  permission("ANNOUNCEMENTS_WINNER_MARK", "announcements.winner.mark", "COMMUNICATIONS", "Mark campaign winners", "Mark a qualified tracked campaign participant as a winner.", "PRIVILEGED"),
  permission("ANNOUNCEMENTS_WINNERS_VIEW", "announcements.winners.view", "COMMUNICATIONS", "View campaign winners", "View tracked campaign winner history."),
  ...
  permission("FEATURE_CONTROL_VIEW", "feature_control.view", "FEATURE_CONTROL", "View Feature Control", "View customer feature configuration and history."),
  permission("FEATURE_CONTROL_MANAGE", "feature_control.manage", "FEATURE_CONTROL", "Manage Feature Control", "Enable, disable, show, hide, and schedule customer features.", "PRIVILEGED"),
  permission("FEATURE_CONTROL_PROTECTED_MANAGE", "feature_control.protected_manage", "FEATURE_CONTROL", "Manage protected features", "Change protected financial feature availability.", "CRITICAL"),
  permission("BRANCH_DASHBOARD_VIEW", "branch.dashboard.view", "BRANCHES", "View branch dashboard", "View the authenticated branch dashboard."),
  permission("BRANCH_TARGETS_VIEW", "branch.targets.view", "BRANCHES", "View branch targets", "View authenticated branch targets."),
  permission("BRANCH_REPORTS_VIEW", "branch.reports.view", "BRANCHES", "View branch reports", "View authenticated branch reports."),
  permission("BRANCH_STAFF_VIEW", "branch.staff.view", "BRANCHES", "View branch staff", "View staff in the authenticated branch."),
  permission("BRANCH_STAFF_MANAGE", "branch.staff.manage", "BRANCHES", "Manage branch staff", "Manage existing staff in the authenticated branch.", "PRIVILEGED"),
  permission("BRANCH_CUSTOMERS_VIEW", "branch.customers.view", "BRANCHES", "View branch customers", "View authenticated branch customers."),
  permission("BRANCH_CUSTOMERS_CREATE", "branch.customers.create", "BRANCHES", "Create branch customers", "Create customers for the authenticated branch.", "PRIVILEGED"),
  permission("BRANCH_KYC_MANAGE", "branch.kyc.manage", "BRANCHES", "Assign branch KYC", "Assign branch KYC workloads without approval authority.", "PRIVILEGED"),
  permission("BRANCH_DELIVERY_VIEW", "branch.delivery.view", "BRANCHES", "View branch delivery", "View branch delivery records."),
  permission("BRANCH_DELIVERY_MANAGE", "branch.delivery.manage", "BRANCHES", "Manage branch delivery", "Manage branch delivery records.", "PRIVILEGED"),
  permission("BRANCH_SOLAR_VIEW", "branch.solar.view", "BRANCHES", "View branch solar", "View branch solar records."),
  permission("BRANCH_SOLAR_MANAGE", "branch.solar.manage", "BRANCHES", "Manage branch solar", "Manage branch solar records.", "PRIVILEGED"),
  permission("BRANCH_MARKETPLACE_VIEW", "branch.marketplace.view", "BRANCHES", "View branch marketplace", "View branch marketplace records."),
  permission("BRANCH_MARKETPLACE_MANAGE", "branch.marketplace.manage", "BRANCHES", "Manage branch marketplace", "Manage branch marketplace records.", "PRIVILEGED"),
  permission("BRANCH_PHONE_VIEW", "branch.phone.view", "BRANCHES", "View branch phone financing", "View branch phone financing records."),
  permission("BRANCH_PHONE_MANAGE", "branch.phone.manage", "BRANCHES", "Manage branch phone financing", "Manage branch phone financing records.", "PRIVILEGED"),
  permission("BRANCH_EMPOWERMENT_VIEW", "branch.empowerment.view", "BRANCHES", "View branch empowerment", "View branch empowerment records."),
  permission("BRANCH_EMPOWERMENT_MANAGE", "branch.empowerment.manage", "BRANCHES", "Manage branch empowerment", "Manage branch empowerment records.", "PRIVILEGED"),
  permission("BRANCH_APPROVALS_VIEW", "branch.approvals.view", "BRANCHES", "View branch approvals", "View branch approval requests."),
  permission("BRANCH_APPROVALS_SUBMIT", "branch.approvals.submit", "BRANCHES", "Submit branch approvals", "Submit branch approval requests."),
  permission("BRANCH_FINANCE_VIEW", "branch.finance.view", "BRANCHES", "View branch finance", "View branch financial records."),
  permission("BRANCHES_VIEW", "branches.view", "BRANCHES", "View all branches", "View all ServicePay branches."),
  permission("BRANCHES_MANAGE", "branches.manage", "BRANCHES", "Manage all branches", "Create and configure ServicePay branches.", "PRIVILEGED"),
  permission("BRANCHES_TARGETS_MANAGE", "branches.targets.manage", "BRANCHES", "Manage branch targets", "Create or directly update branch targets.", "PRIVILEGED"),
...
const STAFF_PERMISSION_ALIASES = Object.freeze({
  ...
  "announcement.participants.view": STAFF_PERMISSIONS.ANNOUNCEMENTS_PARTICIPANTS_VIEW,
  "announcement.participants.history_view": STAFF_PERMISSIONS.ANNOUNCEMENTS_PARTICIPANTS_HISTORY_VIEW,
  "announcement.winner.mark": STAFF_PERMISSIONS.ANNOUNCEMENTS_WINNER_MARK,
  "announcement.winners.view": STAFF_PERMISSIONS.ANNOUNCEMENTS_WINNERS_VIEW,
...
const directRolePermissions = Object.freeze({
  ...
  BRANCH_MANAGER: Object.freeze([
    ...
    STAFF_PERMISSIONS.BRANCH_KYC_MANAGE,
