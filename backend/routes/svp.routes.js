...
router.post("/", ...headOffice, c.create);
router.get("/", ...headOffice, c.list);
router.get("/reports", ...headOffice, c.headOfficeReports);
router.get("/audit", ...headOffice, c.headOfficeAudit);
...
router.patch("/reports/:id/review", ...headOffice, validId, c.reviewReport);
router.get("/reports/:id", ...headOffice, validId, c.headOfficeReport);
...
router.patch("/:id/status", ...headOffice, validId, c.status);
router.post("/:id/reset-password", ...headOffice, validId, c.resetPassword);
router.post("/:id/revoke-sessions", ...headOffice, validId, c.revokeSessions);
router.get("/:id", ...headOffice, validId, c.detail);
router.patch("/:id", ...headOffice, validId, c.update);
