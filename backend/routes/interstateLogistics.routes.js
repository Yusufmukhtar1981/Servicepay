...
router.post("/shipments/:id/pay", protect, customerOnly, c.pay);
router.post("/shipments/:id/pay-adjustment", protect, customerOnly, c.paySupplement);
...
router.post("/:id/pay", protect, customerOnly, c.pay);
