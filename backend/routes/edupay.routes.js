...
router.patch("/school/sessions/:sessionId", ...schoolManager, academic.updateSession);
router.patch("/school/terms/:termId", ...schoolManager, academic.updateTerm);
...
router.patch("/school/fees/:feeId", ...schoolManager, controller.schoolUpdateFee);
...
router.patch("/school/academic/terms/:termId", ...school, academic.updateTerm);
router.post("/school/academic/classes", ...school, academic.createClass);
router.post("/school/academic/classes/batch", ...school, academic.createClassesBatch);
