...
exports.catalog = (req, res) => res.json({ success: true, data: [
  ...
  { key: "accountDeletion", endpoint: "/account-deletion-requests", permission: "privacy.view", live: true, capabilities: ["search", "filter", "approve", "reject", "complete", "immutableHistory"], retentionPreserved: true },
