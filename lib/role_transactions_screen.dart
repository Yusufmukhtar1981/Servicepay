...
class RoleTransactionsScreen extends StatefulWidget {
  const RoleTransactionsScreen({super.key});

  @override
  State<RoleTransactionsScreen> createState() => _RoleTransactionsScreenState();
}

class _RoleTransactionsScreenState extends State<RoleTransactionsScreen> {
  ...
  Future<void> loadTransactions({
    ...
    try {
      ...
      final Uri uri = Uri.parse(
        '$baseUrl/management/role-transactions',
      ).replace(
        queryParameters: {
          'page': '1',
          'limit': '100',
