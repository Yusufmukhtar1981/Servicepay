...
class AdminSupportApi {
  ...
  Future<Map<String, dynamic>> reply(String id, String message,
          {required String idempotencyKey}) =>
      _request('POST', 'tickets/${Uri.encodeComponent(id)}/replies', payload: {
        'message': message.trim(),
        'idempotencyKey': idempotencyKey
      });
  Future<Map<String, dynamic>> note(String id, String note,
          {required String idempotencyKey}) =>
      _request('POST', 'tickets/${Uri.encodeComponent(id)}/notes',
          payload: {'body': note.trim(), 'idempotencyKey': idempotencyKey});
  Future<List<Map<String, dynamic>>> staff(String search) async {
    final data = await _request('GET', 'staff',
