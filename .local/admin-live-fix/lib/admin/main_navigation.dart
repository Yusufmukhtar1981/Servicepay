...
import 'admin_calls_permissions.dart';
...
/*
     ...
     * SERVICEPAY CALLS
     * =====================================================
     * Metadata is strictly read-only.
     */
    if (isHeadOffice || hasPermission(callsViewPermission)) {
      addNavigationPage(
        page: const AdminCallsScreen(),
        icon: Icons.call_outlined,
        activeIcon: Icons.call_rounded,
        label: 'ServicePay Calls',
      );
    }
